      ...
      <div className="container mx-auto px-4 relative z-10 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto text-center">
          <div className="bg-[#111] p-4 border-l-2 border-skeet-green">
             ...
             <div className="text-xl font-mono text-white">$0.00069</div>
          </div>
          <div className="bg-[#111] p-4 border-l-2 border-skeet-green">
             <div className="text-gray-500 text-xs uppercase mb-1">Holders</div>
             <div className="text-xl font-mono text-white">4,206</div>
          </div>
          <div className="bg-[#111] p-4 border-l-2 border-skeet-green">
             <div className="text-gray-500 text-xs uppercase mb-1">Market Cap</div>
             <div className="text-xl font-mono text-white">$690,420</div>
          </div>
        </div>
      </div>
    </section>
